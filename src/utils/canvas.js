...
export function makeLine(pt1, pt2, stroke, color) {
  pt1 = pt1 || {
    x: 0,
    y: 0,
  };
...
export function makeLabel(text, fontSize = 24) {
...
export function makeCircle(radius, center, fill, stroke) {
  center = center || {
    x: 0,
    y: 0,
  };
...
export function makeMovablePoint(pt) {
  return new fabric.Circle({
    left: pt.x,
    top: pt.y,
    hasControls: false,
