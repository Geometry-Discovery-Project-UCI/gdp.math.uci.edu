...
export default defineComponent({
  ...
  mounted() {
    ...
    var angleD = new fabric.Rect({
      width: 10,
      height: 10,
      fill: "",
      stroke: "black",
    });
    var angleF = new fabric.Rect({
      width: 10,
      height: 10,
      fill: "",
      stroke: "black",
    ...
    const equation = makeLabel("PF + PE + PD = H");
    ...
    function movePointP() {
      ...
      const lineProjectPF = solveLinearEquation(
        { x: projectPF.x1, y: projectPF.y1 },
        { x: projectPF.x2, y: projectPF.y2 }
      );
      ...
      const lineProjectPE = solveLinearEquation(
        { x: projectPE.x1, y: projectPE.y1 },
        { x: projectPE.x2, y: projectPE.y2 }
      );
      ...
      const pdDist = calculateDistanceBetweenTwoPoints(
        { x: pointP.left, y: pointP.top },
        { x: pointP.left, y: 450 }
      );
      const peDist = calculateDistanceBetweenTwoPoints(
        { x: pointP.left, y: pointP.top },
        { x: pointE.x, y: pointE.y }
      );
      const pfDist = calculateDistanceBetweenTwoPoints(
        { x: pointP.left, y: pointP.top },
        { x: pointF.x, y: pointF.y }
      );
