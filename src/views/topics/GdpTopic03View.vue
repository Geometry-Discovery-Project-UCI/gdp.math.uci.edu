<template>
  ...
  <div id="incenter-wrapper">
    <ATypographyTitle :level="4"
      >Incenter Animated Illustration</ATypographyTitle
    >
  ...
  <div id="centroid-wrapper">
    <ATypographyTitle :level="4"
      >Centroid Animated Illustration</ATypographyTitle
    >
  ...
  <div id="orthocenter-wrapper">
    <ATypographyTitle :level="4"
      >Orthocenter Animated Illustration (Need fixes)</ATypographyTitle
    >
  ...
  mounted() {
    ...
    (() => {
      ...
      const triangle = makeMovablePolygon(
        [
          new fabric.Point(125, 50),
          new fabric.Point(50, 450),
          new fabric.Point(450, 450),
        ],
    ...
    (() => {
      ...
      const triangle = makeMovablePolygon(
        ...
        function (coords: fabric.Point[]) {
          ...
          const intersect = calculateLineIntersectInPoints(
            median1,
            median2
          ) as fabric.Point;
    ...
    (() => {
      ...
      const triangle = makeMovablePolygon(
        ...
        function (coords: fabric.Point[]) {
          ...
          const k1 = new fabric.Point(coords[0].x, coords[0].y);
          const k2 = new fabric.Point(pedalPointOnBC.x, pedalPointOnBC.y);
          const k3 = new fabric.Point(coords[2].x, coords[2].y);

          const arr = drawRightAngleSign(k1, k2, k3, 15);
          a1a3.set({
            x1: arr.anglecoord0.x,
            y1: arr.anglecoord0.y,
            x2: arr.anglecoord2.x,
            y2: arr.anglecoord2.y,
            stroke: "red"
          });

          a2a3.set({
            x1: arr.anglecoord1.x,
            y1: arr.anglecoord1.y,
            x2: arr.anglecoord2.x,
            y2: arr.anglecoord2.y,
            stroke: "red"
          });
