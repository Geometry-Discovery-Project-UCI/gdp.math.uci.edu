        ...
        mounted() {
            ...
            const triangle = new fabric.Polygon(
                ...
                function (coords: Array<fabric.Point>) {
                    ...
                    const lineAL = solveLinearEquation(triangle.points[0], {
                        x: pointL.x,
                        y: pointL.y,
                    });
                    const lineBL = solveLinearEquation(triangle.points[1], {
                        x: pointL.x,
                        y: pointL.y,
                    });
                    const lineCL = solveLinearEquation(triangle.points[2], {
                        x: pointL.x,
                        y: pointL.y,
                    });
                    const lineAM = solveLinearEquation(triangle.points[0], {
                        x: pointM.x,
                        y: pointM.y,
                    });
                    const lineBM = solveLinearEquation(triangle.points[1], {
                        x: pointM.x,
                        y: pointM.y,
                    });
                    const lineCM = solveLinearEquation(triangle.points[2], {
                        x: pointM.x,
                        y: pointM.y,
                    });
                    ...
                    const radius = calculateDistanceBetweenTwoPoints(pointL, pointD);
