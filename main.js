{
    ...
    const topics = [
        new Topic("Morley's Miracle", ["Zhiqin Lu"], "public/images/topic01.png", "topics/topic01", ["morley.js"]),
        new Topic("Ceva's and Menelaus' Theorems", ["Zhiqin Lu", "Xianfu Liu"], "public/images/topic02.png", "topics/topic02"),
        new Topic("Five Triangle Centers", ["Zhiqin Lu", "Shiyi Lyu", "Xinxi Guo"], "public/images/topic03.png", "topics/topic03", ["centroid.js", "incenter.js", "orthocenter.js"]),
        new Topic("Erdős-Mordell Inequality", ["Zhiqin Lu"], "public/images/topic04.png", "topics/topic04"),
        new Topic("Simson Line", ["Zhiqin Lu", "Shiyi Lyu"], "public/images/topic05.png", "topics/topic05", ["simsonline.js"]),
        new Topic("Pascal and Brainchon Theorems", ["Zhiqin Lu", "Xianfu Liu"], "public/images/topic06.png", "topics/topic06"),
        new Topic("Isogonal Conjugate and Isotomic Conjugate Points", ["Zhiqin Lu", "Shiyi Lyu"], "public/images/topic07.png", "topics/topic07", ["isotomic.js"]),
        ...
        new Topic("Newton Line", [], "public/images/topic26.png", "topics/topic26", ["newton-line.js"]),
        ...
        new Topic("Viviani' Theorem", ["Yufei Ren"], "public/images/topic34.png", "topics/topic34"),
        new Topic("Pappus' Area Theorem", ["Dawei Liu"], "public/images/topic35.png", "topics/topic35"),
    ...
    const app = Vue.createApp({
        ...
        methods: {
            reloadMainContent(topic) {
                this.topic = topic;
                axios.get(`${topic.pageUrl}/index.html`).then(response => {
                    rawHtml = response.data;
                    this.rawHtml = rawHtml === "" ? "<li>More resources comming soon...</li>" : rawHtml;
