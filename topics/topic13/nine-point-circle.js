...
function calculateCircumcenter(A, B, C) {
  ...
  const perpendicularBisectorAB = solvePerpendicularLineEquation(
    lineAB.m,
    midPointAB
  );
  ...
  const perpendicularBisectorAC = solvePerpendicularLineEquation(
    lineAC.m,
    midPointAC
  );
...
function calculateOrthocenter(A, B, C) {
